...
export default function DashboardScreen() {
  ...
  const filterOptions = {
    Board: ["CBSE", "ICSE", "State Board", "NIOS"],
  ...
  const courses = [
    ...
    { title: "Commerce", icon: "hand-coin" },
    { title: "Engineering & Tech", icon: "cog" },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View>
            ...
            <Text style={styles.subtitle}>Choose your class & explore</Text>
          </View>
        ...
        >
          {["Board", "Class", "Subject", "Medium"].map((label, i) => {
            const value =
              label === "Board"
                ? filters.board
                : label === "Class"
        ...
        <View style={styles.grid}>
          {exams.map((ex, i) => (
            <TouchableOpacity
              onPress={() => navigation.navigate("SubjectiveScreen")}
              key={i}
